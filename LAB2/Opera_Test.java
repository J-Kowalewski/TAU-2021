...
public class Opera_Test {
    ...
    @Before
    public void setUp() {
        System.setProperty("webdriver.opera.driver", "C://Users//19afr//Documents//PJATK//SEM6//TAU//DRIVERS//operadriver_win64//operadriver.exe");
    ...
    @Test
    public void operaZalandoTest1() throws InterruptedException {
    ...
    @Test
    public void operaZalandoTest2() throws InterruptedException {
        driver.get("https://www.zalando.pl/");
    ...
    @Test
    public void operaZalandoTest3() throws InterruptedException {
        driver.get("https://www.zalando.pl/");
    ...
    @Test
    public void operaLimangoTest2() throws InterruptedException {
        driver.get("https://www.limango.pl/");
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div[2]/div[1]/div/header/div/div[2]/div[2]/a/span")).click();
